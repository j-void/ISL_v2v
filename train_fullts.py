...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(dataset, start=epoch_iter):
        ...
        if no_nexts:
            ...
            loss_D = (loss_dict['D_fake'] + loss_dict['D_real']) * 0.5 + (loss_dict['D_hand_real'] + loss_dict['D_hand_fake']) * 0.5 + (loss_dict['D_hand_left_real'] + loss_dict['D_hand_left_fake']) * 0.5 + (loss_dict['D_hand_right_real'] + loss_dict['D_hand_right_fake']) * 0.5 
