...
def display_skleton(frame, posepts, facepts, r_handpts, l_handpts):
    ...
    for k in range(len(handSeq)):
        ...
        if r_handpts_2d[firstlimb_ind, 2] > 0.05 and r_handpts_2d[secondlimb_ind, 2] > 0.05:
        ...
        if l_handpts_2d[firstlimb_ind, 2] > 0.05 and l_handpts_2d[secondlimb_ind, 2] > 0.05:
