...
class Pix2PixHDModel(BaseModel):
    ...
    def forward(self, label, next_label, image, next_image, zeroshere, hand_bbox, bbox_size, infer=False):
        # Encode Inputs
        ...
        if self.opt.shand_gen:
            ...
            if hand_bbox[4] > 0:
                _hand_label_left_1 = next_label[:, :, hand_bbox[1]:hand_bbox[1]+bbox_size, hand_bbox[0]:hand_bbox[0]+bbox_size]
            ...
            if hand_bbox[5] > 0:        
                _hand_label_right_1 = next_label[:, :, hand_bbox[3]:hand_bbox[3]+bbox_size, hand_bbox[2]:hand_bbox[2]+bbox_size]
        ...
        if self.opt.shand_gen:
            ...
            if hand_bbox[4] > 0:
                I_1[:, :, hand_bbox[1]:hand_bbox[1]+bbox_size, hand_bbox[0]:hand_bbox[0]+bbox_size] = I_hand_left_1[:,:,:hand_size_left_1[0],:hand_size_left_1[1]]
            if hand_bbox[5] > 0:
                I_1[:, :, hand_bbox[3]:hand_bbox[3]+bbox_size, hand_bbox[2]:hand_bbox[2]+bbox_size] = I_hand_right_1[:,:,:hand_size_right_1[0],:hand_size_right_1[1]]
        else:
        ...
        if self.opt.shand_dis:
            ...
            if hand_bbox[4] > 0:
                ...
                fake_hand_left_1[:,:,:hand_size_left_1[0],:hand_size_left_1[1]] = I_1[:, :, hand_bbox[1]:hand_bbox[1]+bbox_size, hand_bbox[0]:hand_bbox[0]+bbox_size]
                ...
                real_hand_left_1[:,:,:hand_size_left_1[0],:hand_size_left_1[1]] = next_image[:, :, hand_bbox[1]:hand_bbox[1]+bbox_size, hand_bbox[0]:hand_bbox[0]+bbox_size]
            ...
            if hand_bbox[5] > 0:
                ...
                fake_hand_right_1[:,:,:hand_size_right_1[0],:hand_size_right_1[1]] = I_1[:, :, hand_bbox[3]:hand_bbox[3]+bbox_size, hand_bbox[2]:hand_bbox[2]+bbox_size]
    ...
    def inference(self, label, prevouts, hand_bbox, bbox_size):
        ...
        if self.opt.shand_gen:
            ...
            if hand_bbox[4] > 0:
                _hand_left_0[:,:,:hand_size_left_0[0],:hand_size_left_0[1]] = initial_I_0[:, :, hand_bbox[1]:hand_bbox[1]+bbox_size, hand_bbox[0]:hand_bbox[0]+bbox_size]
            
            _hand_right_0 = torch.zeros(initial_I_0.shape[0], initial_I_0.shape[1], bbox_size, bbox_size).cuda()
            if hand_bbox[5] > 0:    
                _hand_right_0[:,:,:hand_size_right_0[0],:hand_size_right_0[1]] = initial_I_0[:, :, hand_bbox[3]:hand_bbox[3]+bbox_size, hand_bbox[2]:hand_bbox[2]+bbox_size]
