...
def define_G(input_nc, output_nc, ngf, netG, n_downsample_global=3, n_blocks_global=9, n_local_enhancers=1, 
    ...
    if netG == 'global':    
        ...
        netG = UnetGenerator(input_nc, output_nc, 3, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, gpu_ids=[])
    else:
...
def define_D(input_nc, ndf, n_layers_D, norm='instance', use_sigmoid=False, num_D=1, getIntermFeat=False, gpu_ids=[], netD='multi'):
    if netD == 'multi':        
        ...
        netD = NLayerDiscriminator(input_nc, ndf, n_layers=n_layers_D, norm_layer=nn.BatchNorm2d, use_sigmoid=False, 
